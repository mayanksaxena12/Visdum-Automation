...
/** Deactivate/Activate confirmation modal shown by TeamsList.tsx after the status action is clicked. */
public class TeamStatusModal extends BasePage {
    ...
    public TeamStatusModal(WebDriver driver) {
        super(driver);
    }
